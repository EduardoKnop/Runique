...
class ActiveRunService : Service() {
    ...
    private fun stop() {
        ...
        serviceScope = CoroutineScope(Dispatchers.Main + SupervisorJob()) //TODO: Try to remove this line
        // Once cancelChildren() was used above (end a run and start a new one to test)
    }
